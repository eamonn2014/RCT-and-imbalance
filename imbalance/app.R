                ...
                sidebarLayout(
                    ...
                    sidebarPanel( width=3 ,
                                  ...
                                  div(
                                      ...
                                      textInput('n', 
                                                div(h5(tags$span(style="color:blue", "yyyyyyyyyyyyyyyy"))), "1000"),
                                      
                                      tags$hr(),
                                      textInput('dist', 
                                                div(h5(tags$span(style="color:blue", "yyyyyyyyyyyyyyyy"))), "22,21"),
                                      
                                      textInput('levels', 
                                                div(h5(tags$span(style="color:blue", "yyyyyyyyyyyy"))), "10"),
                                      tags$hr(), 
                                      textInput('or1', 
                                                div(h5(tags$span(style="color:blue", "yyyyyyyyyyyy"))), "2"),
...
server <- shinyServer(function(input, output   ) {
   ...
   c("
    ...
    output$textWithNumber <- renderText({ 
        ...
        HTML(paste0( "xxxxxxxxxxxxxxxxxxxx",min(dat$y)+1," is "
                     , tags$span(style="color:red", p2( f     [1][[1]]) ) ,
                     " xxxxxxxxxxxxxxxxxxxxxxxx "
                     , tags$span(style="color:red", p3(c1)) , 
                     " xxxxxxxxxxxxxxxxxxxxxxxx "
                     , tags$span(style="color:red", p3(1-  c1 )) ," xxxxxxxxxxxxxxxxxxxxx",
                     br(), br(),  
                     ...
                     " xxxxxxxxxxxxxxxx"
                     , tags$span(style="color:red"),  ". xxxxxxxxxxxxxxxx" ,
                     br(), br(),  
